...
const Gender: React.FC<PhoneProps> = ({ navigation }) => {
        ...
        <>
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={styles.container}>
                    ...
                    <View className=' ' style={styles.progressContainer}>
                        <LinearGradient
                    ...
                    <View className=' gap-y-5 ' >
                        ...
                        <View className=' mt-7 '>
                            <Text className=' bg-[#E7E7E7] py-7 text-[#606060] font-semibold text-[16px] px-5 border border-[#E7E7E7] rounded-[10px] ' >Male</Text>
                        </View>
                        <View className='  '>
                            <Text className=' bg-[#E7E7E7] py-7 text-[#606060] font-semibold text-[16px] px-5 border border-[#E7E7E7] rounded-[10px] ' >Female</Text>
                        </View>
                        <View className='  '>
                            <Text className=' bg-[#E7E7E7] py-7 text-[#606060] font-semibold text-[16px] px-5 border border-[#E7E7E7] rounded-[10px] ' >Non-Binary</Text>
                        </View>
                    </View>
                    ...
                    <View className="pb-20 px-5 flex-row justify-between items-center mt-auto">
                        ...
                        {/* Next Button */}
                        <TouchableOpacity onPress={() => { navigation.navigate("looking") }} activeOpacity={0.7}>
