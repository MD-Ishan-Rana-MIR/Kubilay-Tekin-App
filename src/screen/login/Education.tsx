...
const Education: React.FC<PhoneProps> = ({ navigation }) => {
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={styles.container}>
                    ...
                    <View >
                        ...
                        <View className=' mt-7 '>
                            <TextInput
                                placeholder="Uttara University"
                                placeholderTextColor="#777"
                                className=' rounded-[10px] bg-[#E7E7E7] py-6 px-6 '
                            />
                        </View>
                    </View>
                    ...
                    <View className="pb-20 px-5 flex-row justify-between items-center mt-auto">
                        ...
                        {/* Next Button */}
                        <TouchableOpacity onPress={() => { navigation.navigate("loop") }} activeOpacity={0.7}>
