...
type LoginScreenNavigationProp = StackNavigationProp<RootStackParamList, 'education'>;

interface PhoneProps {
    navigation: LoginScreenNavigationProp;
}

const Loop: React.FC<PhoneProps> = ({ navigation }) => {
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={styles.container}>
                    ...
                    <Text className="mt-2.5 text-sm text-[#080808]">
                        Receive marketing emails about campaigns and offers.
                    </Text>
                    ...
                    <View >
                        ...
                        {/* Phone Input */}
                        <View className=' mt-7 '>
                            <Text className='text-[#080808] text-[16px] mb-4  ' >Your email</Text>
                            <TextInput
                                placeholder="user@example.com"
                                placeholderTextColor="#777"
                                className=' rounded-[10px] bg-[#E7E7E7] py-4 px-6 '
                            />
                            <TouchableOpacity className=' text-sm border border-[#B14EFF] bg-[#B14EFF1A] rounded-[10px] mt-5 ' >
                    ...
                    <View className="pb-20 px-5 flex-row justify-between items-center mt-auto">
                        ...
                        {/* Next Button */}
                        <TouchableOpacity onPress={() => { navigation.navigate("event") }} activeOpacity={0.7}>
